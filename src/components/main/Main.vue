          ...
          content: [
            ...
            },
            {
              ...
              data: {
                ...
                text: 'The Internet has turbocharged innovation by being one of the great equalizers in human history — but increasing consolidation of control threatens that progress. IPFS stays true to the original vision of an open, flat web by delivering technology to make that vision a reality.',
              },
            },
          ],
        },
          ...
          content: [
            {
              id: 1,
              type: 'text',
              data: 'I saw that, looks super easy. I\'ll have to give that a try. Leon told me about it.',
            },
            {
              id: 2,
              type: 'text',
              data: 'Oh by the way, if you\'re reading this, try clicking around a bit.',
            },
          ],
        },
        {
          ...
          content: [
            {
              id: 1,
              type: 'text',
              data: 'Oh BTW, here\'s what I owe you for lunch.',
            },
            {
              id: 3,
              type: 'payment',
              data: {
                ...
                link: 'https://etherscan.io/tx/0x551c45dfa6a854ce54589a6388c89240915c4d43786957e5069aa1df76df02d0',
              },
            },
          ],
        },
